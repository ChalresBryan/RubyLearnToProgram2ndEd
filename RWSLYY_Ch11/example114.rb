=begin
Safer picture downloading. Adapt the picture-downloading/filerenaming program to your computer by adding some safety features to make sure you never overwrite a file. A few methods you
